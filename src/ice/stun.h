...
enum stun_attr_type {
    STUN_ATTR_MAPPED_ADDRESS = 0x0001, /* stun_attr_sockaddr_t     | RFC 5389  */
    STUN_ATTR_RESPONSE_ADDRESS = 0x0002, /* stun_attr_sockaddr_t     | RFC 5389  */
    STUN_ATTR_CHANGE_REQUEST = 0x0003, /* stun_attr_uint32       | RFC 5780  */
    STUN_ATTR_SOURCE_ADDRESS = 0x0004, /* stun_attr_sockaddr_t     | RFC 5389  */
    STUN_ATTR_CHANGED_ADDRESS = 0x0005, /* stun_attr_sockaddr_t     | RFC 5389  */
    STUN_ATTR_USERNAME = 0x0006, /* stun_attr_varsize_t      | RFC 5389  */
    STUN_ATTR_PASSWORD = 0x0007, /* stun_attr_varsize_t      | RFC 5389  */
    STUN_ATTR_MESSAGE_INTEGRITY = 0x0008, /* stun_attr_msgint       | RFC 5389  */
    STUN_ATTR_ERROR_CODE = 0x0009, /* stun_attr_errcode_t      | RFC 5389  */
    STUN_ATTR_UNKNOWN_ATTRIBUTES = 0x000A, /* stun_attr_unknown_t      | RFC 5389  */
    STUN_ATTR_REFLECTED_FROM = 0x000B, /* stun_attr_sockaddr_t     | RFC 5389  */
    ...
    STUN_ATTR_XOR_PEER_ADDRESS = 0x0012, /* stun_attr_xor_sockaddr_t | RFC 5766  */
    STUN_ATTR_DATA = 0x0013, /* stun_attr_varsize_t      | RFC 5766  */
    STUN_ATTR_REALM = 0x0014, /* stun_attr_varsize_t      | RFC 5389  */
    STUN_ATTR_NONCE = 0x0015, /* stun_attr_varsize_t      | RFC 5389  */
    STUN_ATTR_XOR_RELAYED_ADDRESS = 0x0016, /* stun_attr_xor_sockaddr_t | RFC 5766  */
    ...
    STUN_ATTR_XOR_MAPPED_ADDRESS = 0x0020, /* stun_attr_xor_sockaddr_t | RFC 5389  */
    ...
    STUN_ATTR_PADDING = 0x0026, /* stun_attr_varsize_t      | RFC 5780  */
    STUN_ATTR_RESPONSE_PORT = 0x0027, /* stun_attr_uint16_pad   | RFC 5780  */
    STUN_ATTR_CONNECTION_ID = 0x002A, /* stun_attr_uint32       | RFC 6062  */
    STUN_ATTR_SOFTWARE = 0x8022, /* stun_attr_varsize_t      | RFC 5389  */
    STUN_ATTR_ALTERNATE_SERVER = 0x8023, /* stun_attr_sockaddr_t     | RFC 5389  */
    ...
    STUN_ATTR_RESPONSE_ORIGIN = 0x802B, /* stun_attr_sockaddr_t     | RFC 5780  */
    STUN_ATTR_OTHER_ADDRESS = 0x802C, /* stun_attr_sockaddr_t     | RFC 5780  */
};
...
typedef struct stun_attr_hdr_t {
    uint16_t type;                               /* attribute type */
    uint16_t length;                             /* length, no padding */
} stun_attr_hdr_t;

typedef struct stun_attr_sockaddr_t {
    stun_attr_hdr_t hdr;
    uint8_t unused;
...
} stun_attr_sockaddr_t;

typedef struct stun_attr_varsize_t {
    stun_attr_hdr_t hdr;
    uint8_t value[1];                            /* variable size value */
} stun_attr_varsize_t;

typedef struct stun_attr_uint8_t {
    stun_attr_hdr_t hdr;
    uint8_t value;                               /* single 8-bit value */
    uint8_t unused[3];
} stun_attr_uint8_t;

typedef struct stun_attr_uint16_t {
    stun_attr_hdr_t hdr;
    uint16_t value;                              /* single 16-bit value */
    uint8_t unused[2];
} stun_attr_uint16_t;

typedef struct stun_attr_uint32_t {
    stun_attr_hdr_t hdr;
    uint32_t value;                              /* single 32-bit value */
} stun_attr_uint32_t;

typedef struct stun_attr_uint64_t {
    stun_attr_hdr_t hdr;
    uint64_t value;                              /* single 64-bit value */
} stun_attr_uint64_t;

typedef struct stun_attr_msgint_t {
    stun_attr_hdr_t hdr;
    uint8_t hmac[20];                            /* HMAC-SHA1 hash */
} stun_attr_msgint_t;

typedef struct stun_attr_errcode_t {
    stun_attr_hdr_t hdr;
    uint16_t unused;
...
typedef struct stun_attr_unknown_t {
    stun_attr_hdr_t hdr;
...
/* Equivalent types */
typedef stun_attr_sockaddr_t stun_attr_xor_sockaddr_t;
typedef stun_attr_uint8_t stun_attr_uint8_pad_t;
typedef stun_attr_uint16_t stun_attr_uint16_pad_t;
 ...
 *  NULL is returned for unknown error codes.
 */
...
void stun_msg_hdr_init(stun_msg_hdr_t *msg_hdr, uint16_t type,
                       const uint8_t tsx_id[12]);

/** Gets the STUN message type. */
uint16_t stun_msg_type(const stun_msg_hdr_t *msg_hdr);

/** Gets the STUN message length (including header). */
size_t stun_msg_len(const stun_msg_hdr_t *msg_hdr);

/** Gets the STUN message end. */
const uint8_t *stun_msg_end(const stun_msg_hdr_t *msg_hdr);

/** Initializes a generic attribute header */
void stun_attr_hdr_init(stun_attr_hdr_t *attr_hdr, uint16_t type, uint16_t len);

/** Gets the STUN attribute end. */
uint8_t *stun_attr_end(stun_attr_hdr_t *attr_hdr);

/** Initializes a sockaddr attribute */
int stun_attr_sockaddr_init(stun_attr_sockaddr_t *sockaddr_attr, uint16_t type,
                            const struct sockaddr *addr);

/** Initializes a XOR'ed sockaddr attribute */
int stun_attr_xor_sockaddr_init(stun_attr_xor_sockaddr_t *sockaddr_attr,
                                uint16_t type, const struct sockaddr *addr,
                                const stun_msg_hdr_t *msg_hdr);

/** Initializes a varsize attribute. Check macro STUN_ATTR_VARSIZE_SIZE for
 * the correct attribute size.
 */
void stun_attr_varsize_init(stun_attr_varsize_t *attr, uint16_t type,
 ...
 *     +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
 */
void stun_attr_uint8_init(stun_attr_uint8_t *attr, uint16_t type, uint8_t value);
 ...
 *     +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
 */
void stun_attr_uint8_pad_init(stun_attr_uint8_pad_t *attr, uint16_t type,
 ...
 *     +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
 */
void stun_attr_uint16_init(stun_attr_uint16_t *attr, uint16_t type,
                           uint16_t value);
 ...
 *     +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
 */
void stun_attr_uint16_pad_init(stun_attr_uint16_pad_t *attr, uint16_t type,
                               uint16_t value, uint8_t pad);

/* Initializes a 32-bit attribute */
void stun_attr_uint32_init(stun_attr_uint32_t *attr, uint16_t type,
                           uint32_t value);

/* Initializes a 64-bit attribute */
void stun_attr_uint64_init(stun_attr_uint64_t *attr, uint16_t type,
                           uint64_t value);

/* Initializes an ERROR-CODE attribute */
void stun_attr_errcode_init(stun_attr_errcode_t *attr, int err_code,
                            const char *err_reason, uint8_t pad);

/* Initializes an UNKNOWN-ATTRIBUTES attribute */
void stun_attr_unknown_init(stun_attr_unknown_t *attr,
 ...
 */
void stun_attr_msgint_init(stun_attr_msgint_t *attr, const stun_msg_hdr_t *msg_hdr,
 ...
 * header.
 */
void stun_attr_fingerprint_init(stun_attr_uint32_t *attr,
                                const stun_msg_hdr_t *msg_hdr);

/* Appends an attribute to the STUN message header. */
void stun_msg_add_attr(stun_msg_hdr_t *msg_hdr, const stun_attr_hdr_t *attr);

/* Adds an empty attribute to the message end */
void stun_attr_empty_add(stun_msg_hdr_t *msg_hdr, uint16_t type);

/* Adds a sockaddr attribute to the message end */
int stun_attr_sockaddr_add(stun_msg_hdr_t *msg_hdr, uint16_t type,
                           const struct sockaddr *addr);

/* Adds a XOR'ed sockaddr attribute to the message end */
int stun_attr_xor_sockaddr_add(stun_msg_hdr_t *msg_hdr, uint16_t type,
                               const struct sockaddr *addr);

/* Adds a varsize attribute to the message end */
void stun_attr_varsize_add(stun_msg_hdr_t *msg_hdr, uint16_t type,
                           const void *buf, size_t buf_size, uint8_t pad);

/* Adds an 8-bit attribute to the message end */
void stun_attr_uint8_add(stun_msg_hdr_t *msg_hdr, uint16_t type, uint8_t value);

/* Adds an 8-bit attribute with padding to the message end */
void stun_attr_uint8_pad_add(stun_msg_hdr_t *msg_hdr, uint16_t type,
                             uint8_t value, uint8_t pad);

/* Adds a 16-bit attribute to the message end */
void stun_attr_uint16_add(stun_msg_hdr_t *msg_hdr, uint16_t type,
                          uint16_t value);

/* Adds a 16-bit attribute with padding to the message end */
void stun_attr_uint16_pad_add(stun_msg_hdr_t *msg_hdr, uint16_t type,
                              uint16_t value, uint8_t pad);

/* Adds a 32-bit attribute to the message end */
void stun_attr_uint32_add(stun_msg_hdr_t *msg_hdr, uint16_t type,
                          uint32_t value);

/* Adds a 64-bit attribute to the message end */
void stun_attr_uint64_add(stun_msg_hdr_t *msg_hdr, uint16_t type,
                          uint64_t value);

/* Adds an ERROR-CODE attribute to the message end */
void stun_attr_errcode_add(stun_msg_hdr_t *msg_hdr, int err_code,
                           const char *err_reason, uint8_t pad);

/* Adds an UNKNOWN-ATTRIBUTES attribute to the message end */
void stun_attr_unknown_add(stun_msg_hdr_t *msg_hdr,
                           const uint16_t *unknown_codes, size_t count,
                           uint8_t pad);

/* Adds a MESSAGE-INTEGRITY to the message end */
void stun_attr_msgint_add(stun_msg_hdr_t *msg_hdr,
                          const void *key, size_t key_len);

/* Adds a FINGERPRINT attribute to the message end */
void stun_attr_fingerprint_add(stun_msg_hdr_t *msg_hdr);

/** Check the validity of an incoming STUN packet.
 *
 *  Performs several checks, including the MESSAGE-INTEGRITY, if available.
 *
 *  @return Zero if invalid.
 */
int stun_msg_verify(const stun_msg_hdr_t *msg_hdr, size_t msg_size);

/* Gets the attribute length (inner length, no padding) */
size_t stun_attr_len(const stun_attr_hdr_t *attr_hdr);

/* Gets the attribute block length (with padding) */
size_t stun_attr_block_len(const stun_attr_hdr_t *attr_hdr);

/* Gets the attribute type */
uint16_t stun_attr_type(const stun_attr_hdr_t *attr_hdr);
 ...
 */
const stun_attr_hdr_t *stun_msg_next_attr(const stun_msg_hdr_t *msg_hdr,
                                          const stun_attr_hdr_t *attr_hdr);

/* Finds a specific STUN attribute in the provided message. It will perform
 * a linear search over the available attributes.
 */
const stun_attr_hdr_t *stun_msg_find_attr(const stun_msg_hdr_t *msg_hdr,
                                          uint16_t type);

/* Reads a sockaddr attribute. Returns error case the address family
 * is unknown (should be STUN_IPV4 or STUN_IPV6).
 */
int stun_attr_sockaddr_read(const stun_attr_sockaddr_t *attr,
                            struct sockaddr *addr);

/* Reads a XOR'red sockaddr attribute. Returns error case the address family
 * is unknown (should be STUN_IPV4 or STUN_IPV6).
 */
int stun_attr_xor_sockaddr_read(const stun_attr_xor_sockaddr_t *attr,
                                const stun_msg_hdr_t *msg_hdr,
                                struct sockaddr *addr);

/* Reads a varsize attribute. The length is returned by stun_attr_len */
const void *stun_attr_varsize_read(const stun_attr_varsize_t *attr);

/* Reads an 8-bit attribute */
uint8_t stun_attr_uint8_read(const stun_attr_uint8_t *attr);

/* Reads a 16-bit attribute */
uint16_t stun_attr_uint16_read(const stun_attr_uint16_t *attr);

/* Reads a 32-bit attribute */
uint32_t stun_attr_uint32_read(const stun_attr_uint32_t *attr);

/* Reads a 64-bit attribute */
uint64_t stun_attr_uint64_read(const stun_attr_uint64_t *attr);

/** Gets the status code from the ERROR-CODE attribute */
int stun_attr_errcode_status(const stun_attr_errcode_t *attr);

/** Gets the reason phrase from the ERROR-CODE attribute */
const char *stun_attr_errcode_reason(const stun_attr_errcode_t *attr);

/** Gets the reason phrase length from the ERROR-CODE attribute */
size_t stun_attr_errcode_reason_len(const stun_attr_errcode_t *attr);

/* Gets the number of unknown attributes contained in a UNKNOWN-ATTRIBUTES
 * attribute.
 */
size_t stun_attr_unknown_count(const stun_attr_unknown_t *attr);

/* Gets the nth occurrence of unknown attributes.
 */
uint16_t stun_attr_unknown_get(const stun_attr_unknown_t *attr, size_t n);

/** Checks the MESSAGE-INTEGRITY attribute. */
int stun_attr_msgint_check(const stun_attr_msgint_t *msgint,
                           const stun_msg_hdr_t *msg_hdr,
 ...
 */
int stun_attr_fingerprint_check(const stun_attr_uint32_t *fingerprint,
                                const stun_msg_hdr_t *msg_hdr);
#ifdef __cplusplus
}
#endif
